...
public abstract class RGBPixel extends Pixel {
    ...
    public double sqDiff(Pixel other) {
        ...
        if (other instanceof RGBPixel rgbPixel) {
            int otherRed = rgbPixel.red();
            int otherGreen = rgbPixel.green();
            int otherBlue = rgbPixel.blue();
