...
El archivo \texttt{.fc} que produce la implementación almacena estos campos en representación textual con el fin de permitir al lector su inspección directa.
